namespace mp4_parse_test2.Mp4.Types
{
    ...
    enum BoxType : uint
    {
        ...
        avc1 = SampleEntryCode.avc1, // ('a' << 24) | ('v' << 16) | ('c' << 8) | ('1' << 0),
        mp4v = SampleEntryCode.mp4v, // ('m' << 24) | ('p' << 16) | ('4' << 8) | ('v' << 0),
        mp4a = SampleEntryCode.mp4a, // ('m' << 24) | ('p' << 16) | ('4' << 8) | ('a' << 0),
        esds = ('e' << 24) | ('s' << 16) | ('d' << 8) | ('s' << 0),
        btrt = ('b' << 24) | ('t' << 16) | ('r' << 8) | ('t' << 0),
        uri = ('u' << 24) | ('r' << 16) | ('i' << 8) | (' ' << 0),
        uriI = ('u' << 24) | ('r' << 16) | ('i' << 8) | ('I' << 0),
    ...
    enum ColourType : uint
    {
        OnScreenColours = ('n' << 24) | ('c' << 16) | ('l' << 8) | ('x' << 0),
        RestrictedICCProfile = ('r' << 24) | ('I' << 16) | ('C' << 8) | ('C' << 0),
        UnrestrictedICCProfile = ('p' << 24) | ('r' << 16) | ('o' << 8) | ('f' << 0),
    }
}
